...
**Dips & Spreads** (12 hummus recipes from [13 Hummus Recipes That Stole the Spotlight From Every Other Dip](https://immigrantstable.com/13-hummus-recipes-stole-spotlight-every-dip/))
...
56 more recipes were added in batch 3 (128 → 184) of converting the ["Food & Flavors" Flipboard magazine](https://flipboard.com/@enetoe/food-flavors-acbn0akgy) (batch 1 added the first 62, batch 2 added 50 more — the magazine has about 7,730 saved stories total). Roundup/listicle links, non-recipe review articles, and pages blocked by the sandbox's network allowlist (eatingwell.com, simplyrecipes.com, receitas.globo.com, and intermittently xoxobella.com/southernliving.com/gamintraveler.com in this batch) were intentionally skipped rather than guessed at. See `_build/flipboard-batch-3-report.md` for the full accounting (and `_build/flipboard-batch-1-report.md` / `_build/flipboard-batch-2-report.md` for earlier batches), plus `_cookbook-meta-prompt.md` §6c for the duplicate-detection rule this project runs before every batch. Just say "convert the next batch" to continue with batch 4.
